        ...
        <main style={{ fontFamily: 'sans-serif', minHeight: '100vh', background: '#f9f7f4' }}>
            <nav style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '1rem 2rem', background: '#2D5A27', borderBottom: '1px solid #1a3d18' }}>
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
                    <a href="/register" style={{ color: '#fff', textDecoration: 'none', fontSize: '0.95rem' }}>
                        {lang === 'tr' ? 'Hesabın yok mu?' : "Don't have an account?"}{' '}
                        <strong>{lang === 'tr' ? 'Ücretsiz Başla' : 'Get Started'}</strong>
                    </a>
                    <LanguageSwitcher />
                </div>
            </nav>
            ...
            <div style={{ maxWidth: '420px', margin: '5rem auto', background: '#fff', borderRadius: '16px', border: '1px solid #eee', padding: '2.5rem' }}>
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <p style={{ textAlign: 'center', fontSize: '0.85rem', color: '#aaa', marginTop: '1.5rem' }}>
                        {lang === 'tr' ? 'Hesabın yok mu?' : "Don't have an account?"}{' '}
                        <a href="/register" style={{ color: '#2D5A27', textDecoration: 'none', fontWeight: 'bold' }}>
